...
parser.add_argument('--random_seed', type=int, default=1000)  # 👈 Aquí está el que falta
...
tracker = EmissionsTracker(project_name="AutoRec_Model", output_dir="./results/")
tracker.start()

model = AutoRec(args, num_users, num_items, R, mask_R, C, train_R, train_mask_R, test_R, test_mask_R, num_train_ratings, num_test_ratings, user_train_set, item_train_set, user_test_set, item_test_set, "./results/")
model.run()
